...
perl ../../tools/ncomms15324-s10/Fragment_Guided_Graph_Assembly.pl -Align=$align -Ref=$ref -Query=$reads -Script=$script -OutDir=$output -MinIden=90 -MaxHang=1000 -MinLap=2000 
